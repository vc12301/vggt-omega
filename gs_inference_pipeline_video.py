...
def main() -> None:
    ...
    parser.add_argument("--video", default=f"examples/{scene}.mp4", help="Input video file")
    ...
    parser.add_argument("--max_frames", type=int, default=45, help="Limit number of frames used for inference")
    add_gs_args(parser)
